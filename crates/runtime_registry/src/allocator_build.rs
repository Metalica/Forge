...
compile_error!(
    "runtime_registry requires one allocator build mode feature: allocator-mimalloc, allocator-jemalloc, or allocator-snmalloc"
);
...
compile_error!(
    "runtime_registry allocator build mode must be singular; use --no-default-features when selecting allocator-jemalloc or allocator-snmalloc"
);
